...
modBoilerplate is a base Extra template that is useful when wanting to create a new
...
Then, navigate to the directory modBoilerplate is now in, and do this:
...
Now, you'll want to change references to modBoilerplate in the files in your
new copied-from-modBoilerplate repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'modBoilerplate' to whatever the
