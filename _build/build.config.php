...
/* define package */
define('PKG_NAME', 'modBoilerplate');
...
if (file_exists(MODX_BASE_PATH . 'connectors-AFyYsQrk')) {
  define('MODX_CONNECTORS_PATH', MODX_BASE_PATH . 'connectors-AFyYsQrk/');
  define('MODX_CONNECTORS_URL', MODX_BASE_URL . 'connectors-AFyYsQrk/');
} else {
